...
<input type="text" name="kode" value="<?= htmlspecialchars($d['kode_barang']); ?>" required>

<label>Nama Barang</label>
<input type="text" name="nama" value="<?= htmlspecialchars($d['nama_barang']); ?>" pattern="[A-Za-z\s]+" required>

<label>Satuan</label>
<input type="text" name="satuan" value="<?= htmlspecialchars($d['satuan']); ?>">
...
<textarea name="keterangan"><?= htmlspecialchars($d['keterangan']); ?></textarea>
...
<img src="upload/<?= htmlspecialchars($d['foto']); ?>" width="120">
